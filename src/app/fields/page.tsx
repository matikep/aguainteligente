...
import { PlusCircle, Droplet, Thermometer, Eye, Edit, Trash2 } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <h1 className="text-3xl font-bold">Gestión de Campos</h1>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center"><Droplet className="inline-block h-5 w-5" title="Humedad" /></TableHead>
                <TableHead className="text-center hidden sm:table-cell"><Thermometer className="inline-block h-5 w-5" title="Temperatura" /></TableHead>
